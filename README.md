...
Katalog referensi ekosistem PHP modern: framework, library, tooling, CMS, testing, security, deployment, observability, AI/ML, dan daftar legacy yang perlu direview sebelum dipakai.

> Terakhir ditinjau: 20 Juni 2026  
> Target utama: PHP 8.4/8.5, Composer 2.x, package aktif, dependency aman, dan pilihan yang relevan untuk project baru.  
> Catatan: nomor patch dapat berubah cepat. Untuk angka patch paling baru, jalankan `composer outdated`, `composer show vendor/package --all`, dan cek release page resmi.

## Cara membaca status

| Status | Arti |
|---|---|
| Recommended | Aman untuk project baru dan umum dipakai. |
| Stable | Masih baik dipakai, tetapi pilih sesuai kebutuhan. |
| Advanced | Cocok untuk kebutuhan khusus/performa tinggi. |
| Specialized | Bagus untuk use case tertentu, tidak selalu perlu. |
| Legacy/Review | Boleh dipelajari atau dipakai di proyek lama, tapi jangan otomatis dipakai untuk project baru. |
| Avoid for new projects | Hindari untuk project baru; gunakan pengganti modern. |

## Rekomendasi cepat

| Kebutuhan | Pilihan utama | Alternatif | Catatan |
| --- | --- | --- | --- |
| Runtime project baru | PHP 8.5 | PHP 8.4 / 8.3 | Gunakan 8.5 untuk project baru; 8.4 masih sangat aman; 8.3 cocok jika dependensi belum siap. |
| Full-stack web app | Laravel 13 | Symfony 7.4 LTS / Symfony 8.1 | Laravel paling produktif; Symfony unggul untuk enterprise dan komponen reusable. |
| API backend | Laravel 13 + Sanctum/Passport | Symfony + API Platform, Slim 4, Mezzio | Pilih sesuai kompleksitas domain dan kebutuhan tim. |
| CMS populer | WordPress 7.0 | Drupal 11.x, Joomla 6.x | WordPress paling luas; Drupal/Joomla untuk struktur konten lebih formal. |
| E-commerce | WooCommerce | Magento/Adobe Commerce, Sylius 2, PrestaShop, Shopware 6 | WooCommerce cepat; Sylius/Magento/Shopware cocok untuk commerce serius. |
| Testing | PHPUnit 12/13 | Pest 4, Codeception, Behat | Pest ringkas; PHPUnit tetap standar ekosistem PHP. |
| Static analysis | PHPStan 2 | Psalm 6, Phan | Wajib untuk codebase jangka panjang. |
| Code style | Laravel Pint | PHP-CS-Fixer 3, PHP_CodeSniffer | Jalankan di CI agar standar konsisten. |
| Security audit | composer audit | Roave Security Advisories | Minimal wajib sebelum deploy. |
| Async / realtime | Laravel Octane, RoadRunner, Swoole/OpenSwoole | ReactPHP, AMPHP, Workerman | Pakai hanya saat memang butuh concurrency/long-running worker. |
| AI / LLM | Laravel AI SDK | OpenAI PHP client, LLPhant, PHP-ML, Rubix ML | Area cepat berubah; pin versi dan cek changelog. |

## Versi populer vs versi terbaru yang cocok

| Teknologi | Versi terbaru/modern | Constraint disarankan | Versi populer/stabil | Catatan |
| --- | --- | --- | --- | --- |
| PHP | 8.5 | 8.5.x | 8.4.x / 8.3.x | Project baru dan runtime modern. |
| Composer | 2.x | 2.9.x+ | 2.8.x | Dependency manager wajib. |
| Laravel | 13.x | ^13.0 | ^12.0 | Laravel 13 membutuhkan PHP 8.3+. |
| Symfony | 8.1 / 7.4 LTS | ^8.1 / ^7.4 | 7.4 LTS | 7.4 untuk LTS, 8.x untuk fitur terbaru. |
| WordPress | 7.0 | 7.x | 6.9.x | CMS paling populer; selalu update patch. |
| Drupal | 11.x | 11.3/11.4 line | 10.6 line | Untuk CMS enterprise/structured content. |
| Joomla | 6.1.x | 6.x | 5.4.x | Joomla 6 terbaru; 5.x masih maintenance. |
| PHPUnit | 12 / 13 | ^12.0 atau ^13.0 | ^11.5 | Pilih sesuai dukungan PHP/framework. |
| Pest | 4.x | ^4.0 | ^3.0 | Testing modern. |
| PHPStan | 2.x | ^2.0 | ^1.12 | Static analysis utama. |
| Rector | 2.x | ^2.0 | ^1.0 | Upgrade/refactor otomatis. |
| Guzzle | 7.x | ^7.0 | - | HTTP client paling umum. |

## Preset stack yang disarankan
...
Cocok untuk SaaS, dashboard, REST API, queue worker, integrasi AI, dan aplikasi bisnis cepat.
...
Cocok untuk domain kompleks, arsitektur modular, enterprise, event-driven app, dan integrasi API Platform.
...
Cocok untuk webhook, service kecil, gateway, worker HTTP, dan prototype cepat.
...
Gunakan PSR-4, semantic versioning, test, static analysis, dan CI sejak awal.

## Framework web dan API

| Nama | Package/Repo | Versi line | Install | Status | Cocok untuk |
| --- | --- | --- | --- | --- | --- |
| Laravel | laravel/laravel | 13.x | `composer create-project laravel/laravel app` | Recommended | Full-stack, API, SaaS, admin, queue, AI-ready. |
| Symfony | symfony/skeleton / symfony/symfony | 8.1 latest / 7.4 LTS | `composer create-project symfony/skeleton app` | Recommended | Enterprise, modular, API besar, komponen reusable. |
| CodeIgniter | codeigniter4/appstarter | 4.x | `composer create-project codeigniter4/appstarter app` | Stable | App ringan, migrasi CI lama; jangan mulai dari CodeIgniter 3. |
| CakePHP | cakephp/app | 5.x | `composer create-project cakephp/app app` | Stable | CRUD cepat, convention-over-configuration. |
| Slim | slim/slim | 4.x | `composer require slim/slim slim/psr7` | Recommended | Micro API, webhook, middleware app. |
| Mezzio | mezzio/mezzio-skeleton | 3.x | `composer create-project mezzio/mezzio-skeleton app` | Stable | PSR middleware dan enterprise API. |
| Laminas MVC | laminas/laminas-mvc-skeleton | 3.x | `composer create-project laminas/laminas-mvc-skeleton app` | Stable | Penerus Zend Framework. |
| Spiral | spiral/app | 3.x | `composer create-project spiral/app app` | Advanced | RoadRunner, long-running app, microservice. |
| Hyperf | hyperf/hyperf-skeleton | 3.x | `composer create-project hyperf/hyperf-skeleton app` | Advanced | Coroutine/Swoole high concurrency. |
| Phalcon | phalcon/cphalcon | 5.x | Extension + Composer packages | Specialized | Performa tinggi, tetapi butuh extension C. |
| Yii | yiisoft/yii2 / yiisoft packages | 2.x stable / 3.x ecosystem | `composer create-project yiisoft/yii2-app-basic app` | Stable/Review | Yii 2 masih populer; cek kesiapan Yii 3 untuk project baru. |
| Fat-Free Framework | bcosca/fatfree | 3.x | `composer require bcosca/fatfree-core` | Lightweight | Micro framework sederhana. |
| Flight | flightphp/core | 3.x | `composer require flightphp/core` | Lightweight | Micro framework kecil dan cepat. |
| Nette | nette/application | 3.x | `composer require nette/application` | Stable | Ekosistem matang di Eropa. |

## CMS, blog, wiki, analytics, dan e-commerce

| Nama | Repo/Package | Versi line | Kegunaan | Status |
| --- | --- | --- | --- | --- |
| WordPress | wordpress/wordpress-develop | 7.0 | CMS/blog paling populer | Recommended |
| WooCommerce | woocommerce/woocommerce | 10.x | E-commerce WordPress | Recommended untuk UMKM/menengah |
| Drupal | drupal/core-recommended | 11.x | CMS enterprise / structured content | Recommended untuk konten kompleks |
| Joomla | joomla/joomla-cms | 6.x / 5.x | CMS general purpose | Stable |
| Grav | getgrav/grav | 1.7+ | Flat-file CMS | Recommended untuk situs ringan |
| October CMS | octobercms/october | 3.x / 4.x | CMS berbasis Laravel | Stable |
| Statamic | statamic/cms | 5.x | Laravel flat-file/database CMS | Recommended |
| Craft CMS | craftcms/cms | 5.x | CMS konten premium/developer-friendly | Strong option |
...
| Shopware | shopware/shopware | 6.x | Modern commerce | Strong Symfony ecosystem |
| OpenCart | opencart/opencart | 4.x | Toko online sederhana | Stable |
| Matomo | matomo-org/matomo | 5.x | Self-hosted analytics | Recommended |
| Nextcloud | nextcloud/server | 31+ / 32+ | Self-hosted cloud | Recommended |
| BookStack | BookStackApp/BookStack | 25.x+ | Documentation/wiki | Recommended |
| DokuWiki | splitbrain/dokuwiki | stable | Wiki tanpa database | Stable |
| MediaWiki | wikimedia/mediawiki | 1.43+ / 1.44+ | Wiki besar seperti Wikipedia | Stable |
| Mautic | mautic/mautic | 5.x / 6.x | Marketing automation | Specialized |

## HTTP, API, auth, integrasi, dan payments

| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
...
| Nyholm PSR-7 | nyholm/psr7 | 1.x | `composer require nyholm/psr7` | Implementasi PSR-7 ringan. |
| API Platform | api-platform/core | 4.x | `composer require api` | REST/GraphQL API otomatis di Symfony/Laravel. |
| webonyx/graphql-php | webonyx/graphql-php | 15.x | `composer require webonyx/graphql-php` | GraphQL server library. |
| swagger-php | zircote/swagger-php | 5.x | `composer require zircote/swagger-php` | OpenAPI annotation/attribute generator. |
| NelmioApiDocBundle | nelmio/api-doc-bundle | 5.x | `composer require nelmio/api-doc-bundle` | Dokumentasi API Symfony. |
| Laravel Sanctum | laravel/sanctum | 4.x | `composer require laravel/sanctum` | Token auth ringan Laravel. |
| Laravel Passport | laravel/passport | 13.x | `composer require laravel/passport` | OAuth2 server Laravel. |
| league/oauth2-server | league/oauth2-server | 9.x | `composer require league/oauth2-server` | OAuth2 server framework-agnostic. |
| lcobucci/jwt | lcobucci/jwt | 5.x | `composer require lcobucci/jwt` | JWT strict dan typed. |
| firebase/php-jwt | firebase/php-jwt | 6.x | `composer require firebase/php-jwt` | JWT sederhana. |
| stripe-php | stripe/stripe-php | 16.x+ | `composer require stripe/stripe-php` | Stripe payments. |
| twilio-php | twilio/sdk | 8.x | `composer require twilio/sdk` | SMS/voice/WhatsApp via Twilio. |
| AWS SDK PHP | aws/aws-sdk-php | 3.x | `composer require aws/aws-sdk-php` | Integrasi AWS. |
| Google API Client | google/apiclient | 2.x | `composer require google/apiclient` | Google APIs. |
| GitHub API PHP | knplabs/github-api | 3.x | `composer require knplabs/github-api` | GitHub REST API client. |

## Database, ORM, cache, search, dan data model

| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| Eloquent ORM | illuminate/database | 13.x | `composer require illuminate/database` | ORM Laravel standalone. |
| Doctrine ORM | doctrine/orm | 3.x | `composer require doctrine/orm` | ORM enterprise/domain complex. |
| Doctrine DBAL | doctrine/dbal | 4.x | `composer require doctrine/dbal` | Database abstraction layer. |
| Cycle ORM | cycle/orm | 2.x | `composer require cycle/orm` | ORM modern schema-based. |
| Propel | propel/propel | 2.x | `composer require propel/propel` | ORM alternatif. |
| Phinx | robmorgan/phinx | 0.16+ | `composer require robmorgan/phinx` | Database migration. |
| Predis | predis/predis | 3.x | `composer require predis/predis` | Redis client PHP. |
| ext-redis | phpredis | 6.x | PECL | Redis extension performa tinggi. |
| Elasticsearch PHP | elasticsearch/elasticsearch | 8.x | `composer require elasticsearch/elasticsearch` | Elasticsearch client. |
| Elastica | ruflin/elastica | 8.x | `composer require ruflin/elastica` | Elasticsearch abstraction. |
| Meilisearch PHP | meilisearch/meilisearch-php | 1.x | `composer require meilisearch/meilisearch-php` | Search modern. |
| TNTSearch | teamtnt/tntsearch | 2.x | `composer require teamtnt/tntsearch` | Full-text search PHP. |
| league/csv | league/csv | 9.x | `composer require league/csv` | CSV reader/writer. |
| moneyphp/money | moneyphp/money | 4.x | `composer require moneyphp/money` | Value object uang. |
| ramsey/uuid | ramsey/uuid | 4.x | `composer require ramsey/uuid` | UUID. |
| symfony/uid | symfony/uid | 7.4 / 8.x | `composer require symfony/uid` | UUID/ULID modern. |

## Testing, quality assurance, static analysis, dan refactor

| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| PHPUnit | phpunit/phpunit | 12.x / 13.x | `composer require --dev phpunit/phpunit` | Unit testing standar. |
| Pest | pestphp/pest | 4.x | `composer require --dev pestphp/pest` | Testing modern dan ringkas. |
| Codeception | codeception/codeception | 5.x | `composer require --dev codeception/codeception` | Acceptance/functional testing. |
...
| PHPStan | phpstan/phpstan | 2.x | `composer require --dev phpstan/phpstan` | Static analysis utama. |
| Psalm | vimeo/psalm | 6.x | `composer require --dev vimeo/psalm` | Static analysis alternatif. |
| Phan | phan/phan | 5.x | `composer require --dev phan/phan` | Static analyzer. |
| Rector | rector/rector | 2.x | `composer require --dev rector/rector` | Automated refactor/upgrade. |
...
| Laravel Pint | laravel/pint | 1.x | `composer require --dev laravel/pint` | Formatter Laravel. |
...
## File, storage, image, PDF, spreadsheet, dan media
...
| Imagine | imagine/imagine | 1.x | `composer require imagine/imagine` | Image manipulation alternatif. |
| Dompdf | dompdf/dompdf | 3.x | `composer require dompdf/dompdf` | HTML ke PDF. |
| mPDF | mpdf/mpdf | 8.x | `composer require mpdf/mpdf` | PDF UTF-8 dari HTML. |
| TCPDF | tecnickcom/tcpdf | 6.x | `composer require tecnickcom/tcpdf` | PDF klasik/barcode. |
| Browsershot | spatie/browsershot | 4.x | `composer require spatie/browsershot` | Screenshot/PDF via browser. |
| PhpSpreadsheet | phpoffice/phpspreadsheet | 2.x / 3.x / 4.x | `composer require phpoffice/phpspreadsheet` | Spreadsheet modern; pengganti PHPExcel. |
| PHPWord | phpoffice/phpword | 1.x | `composer require phpoffice/phpword` | Dokumen Word. |
| Laravel Excel | maatwebsite/excel | 3.x | `composer require maatwebsite/excel` | Import/export Excel Laravel. |
| Spatie Media Library | spatie/laravel-medialibrary | 11.x | `composer require spatie/laravel-medialibrary` | Media management Laravel. |
| PHP-FFMpeg | php-ffmpeg/php-ffmpeg | 1.x | `composer require php-ffmpeg/php-ffmpeg` | Video/audio processing wrapper. |
| Endroid QR Code | endroid/qr-code | 5.x | `composer require endroid/qr-code` | QR code generator. |

## Mail, notification, queue, async, dan realtime

| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| Symfony Mailer | symfony/mailer | 7.4 / 8.x | `composer require symfony/mailer` | Mailer modern. |
| PHPMailer | phpmailer/phpmailer | 6.x | `composer require phpmailer/phpmailer` | Email klasik dan stabil. |
...
| Ratchet | cboden/ratchet | 0.4.x | `composer require cboden/ratchet` | WebSocket server klasik. |
| ReactPHP | react/event-loop | 1.x | `composer require react/event-loop` | Event loop async. |
| AMPHP | amphp/amp | 3.x | `composer require amphp/amp` | Async PHP modern. |
| OpenSwoole/Swoole | openswoole/core / ext-swoole | 22.x / 5.x+ | PECL + Composer | High concurrency server. |
| Workerman | workerman/workerman | 5.x | `composer require workerman/workerman` | Async server sederhana. |
| RoadRunner | spiral/roadrunner | 2025.x | Binary + Composer | PHP application server. |
| Laravel Octane | laravel/octane | 2.x | `composer require laravel/octane` | Laravel high-performance server. |
| php-amqplib | php-amqplib/php-amqplib | 3.x | `composer require php-amqplib/php-amqplib` | RabbitMQ/AMQP. |
...
| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| composer audit | Composer built-in | 2.x | `composer audit` | Audit dependency vulnerabilities. |
| Roave Security Advisories | roave/security-advisories | dev-latest | `composer require --dev roave/security-advisories:dev-latest` | Block package rentan saat install/update. |
| Symfony Security Bundle | symfony/security-bundle | 7.4 / 8.x | `composer require symfony/security-bundle` | Security stack Symfony. |
| spatie/laravel-permission | spatie/laravel-permission | 6.x | `composer require spatie/laravel-permission` | Role/permission Laravel. |
| Bouncer | silber/bouncer | 1.x | `composer require silber/bouncer` | Role/ability Eloquent. |
| Defuse Encryption | defuse/php-encryption | 2.x | `composer require defuse/php-encryption` | Application encryption. |
| phpseclib | phpseclib/phpseclib | 3.x | `composer require phpseclib/phpseclib` | SSH/SFTP/crypto pure PHP. |
| HTML Purifier | ezyang/htmlpurifier | 4.x | `composer require ezyang/htmlpurifier` | Sanitize HTML. |
| Google Authenticator | phpgangsta/googleauthenticator | dev/legacy | `composer require phpgangsta/googleauthenticator` | 2FA legacy; review alternatif modern. |
| iniscan | psecio/iniscan | 0.x/1.x | `composer require --dev psecio/iniscan` | Scan konfigurasi php.ini. |

## Data, fake data, scraping aman, parser, dan utility

| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| FakerPHP | fakerphp/faker | 1.x | `composer require --dev fakerphp/faker` | Fake data; pengganti fzaninotto/faker. |
...
| Symfony Panther | symfony/panther | 2.x | `composer require --dev symfony/panther` | Browser testing/scraping berbasis Chrome. |
| PHP-Parser | nikic/php-parser | 5.x | `composer require nikic/php-parser` | AST parser PHP. |
| league/commonmark | league/commonmark | 2.x | `composer require league/commonmark` | Markdown parser modern. |
| Parsedown | erusev/parsedown | 1.x | `composer require erusev/parsedown` | Markdown parser ringan; cek keamanan/kebutuhan. |
| Geocoder PHP | geocoder-php/geocoder | 4.x | `composer require geocoder-php/geocoder` | Geocoding. |
| Mobile Detect | mobiledetect/mobiledetectlib | 4.x | `composer require mobiledetect/mobiledetectlib` | Deteksi device; gunakan hati-hati. |
...
| SimplePie | simplepie/simplepie | 1.x | `composer require simplepie/simplepie` | RSS/Atom parser. |

## AI, machine learning, dan agentic tooling

| Nama | Package | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| Laravel AI SDK | laravel/ai ecosystem | 13.x | Laravel 13 docs | AI primitives, agents, embeddings, audio, image, vector search. |
| OpenAI PHP Client | openai-php/client | 0.x / 1.x | `composer require openai-php/client` | Integrasi OpenAI API; simpan key di `.env`. |
| LLPhant | theodo-group/llphant | 0.x/1.x | `composer require theodo-group/llphant` | LLM app/RAG framework PHP. |
| PHP-ML | php-ai/php-ml | 0.x | `composer require php-ai/php-ml` | Machine learning klasik. |
| Rubix ML | rubix/ml | 2.x | `composer require rubix/ml` | ML toolkit PHP lebih lengkap. |
| Math PHP | markrogoyski/math-php | 2.x | `composer require markrogoyski/math-php` | Math/statistics utilities. |

## DevOps, deployment, observability, debug, dan profiling

| Nama | Package/Tool | Versi line | Install | Kegunaan |
| --- | --- | --- | --- | --- |
| Deployer | deployer/deployer | 7.x / 8.x | `composer require --dev deployer/deployer` | Deployment PHP. |
| Symfony CLI | Binary | latest | Installer official | Local dev dan Symfony Cloud. |
| Docker Compose | Binary | v2 | Docker Desktop / package manager | Local stack app/database/cache. |
| FrankenPHP | Binary/Docker | 1.x+ | Docker image | Modern PHP app server berbasis Caddy. |
...
| OpenTelemetry PHP | open-telemetry/api | 1.x | `composer require open-telemetry/api` | Tracing/observability. |
| Monolog | monolog/monolog | 3.x | `composer require monolog/monolog` | Logging standar. |
| PsySH | psy/psysh | 0.12+ | `composer require --dev psy/psysh` | REPL modern. |
| Kint | kint-php/kint | 6.x | `composer require --dev kint-php/kint` | Debug output. |
| Clockwork | itsgoingd/clockwork | 5.x | `composer require itsgoingd/clockwork` | Dev profiling/debug. |
| DebugBar | maximebf/debugbar | 1.x | `composer require --dev maximebf/debugbar` | Debug toolbar. |

## Package lama yang sebaiknya diganti

| Package lama | Status | Pengganti modern |
| --- | --- | --- |
...
| facebookarchive/facebook-php-sdk | Archived | OAuth client modern / SDK resmi terbaru |
...
| tymondesigns/jwt-auth | Masih ada tetapi perlu review | Laravel Sanctum, Passport, lcobucci/jwt |
| amazonwebservices/aws-sdk-for-php | Deprecated v1 | aws/aws-sdk-php v3 |
| PayPal-PHP-SDK | Legacy | PayPal Checkout/server SDK terbaru atau payment gateway modern |
...
3. Hindari package archived, abandoned, dan dependency yang sudah tidak punya patch security.
4. Jalankan `composer audit` sebelum deploy.
5. Gunakan constraint jelas: `^13.0`, `^8.1`, `^7.4`, `^3.0`.
6. Tambahkan test, static analysis, formatter, dan audit ke CI.
7. Jangan simpan secret di repository; gunakan `.env`, CI secrets, atau secret manager.
8. Untuk project jangka panjang, prioritaskan LTS atau package dengan jadwal support jelas.
9. Untuk API publik, siapkan rate limit, validation, auth, logging, monitoring, dan OpenAPI docs.
10. Untuk package AI/LLM, pisahkan provider layer agar mudah ganti model/vendor.

## Prioritas belajar / build

1. PHP 8.4/8.5, Composer, PSR-4, PSR-12, error handling, typed properties, attributes.
2. Laravel 13 untuk full-stack, API, queue, dan productivity.
3. Symfony 7.4 LTS/8.x untuk komponen enterprise dan arsitektur modular.
4. PHPUnit/Pest, PHPStan, Rector, PHP-CS-Fixer/Pint.
5. Security: composer audit, auth, authorization, validation, encryption, rate limit.
6. Database: migration, ORM, transaction, indexing, cache, queue.
7. Deployment: Docker, PHP-FPM/FrankenPHP/RoadRunner, scheduler, worker, logging.
8. Observability: Monolog, Sentry, OpenTelemetry.
9. AI integration: embeddings, vector search, queue-based LLM jobs, provider abstraction.
...
| Laravel Packagist | https://packagist.org/packages/laravel/framework |
...
| Joomla latest | https://downloads.joomla.org/latest |
| Composer download | https://getcomposer.org/download/ |
| Packagist | https://packagist.org/ |

## Lampiran A — Backlog referensi lama dari README awal

Bagian ini mempertahankan referensi dari daftar lama agar tidak hilang. Tidak semua item di bawah direkomendasikan untuk project baru. Gunakan kategori utama di atas sebagai pilihan pertama, lalu review item lampiran ini satu per satu sebelum dipakai.
...
## Lampiran B — Security training only

Item berikut hanya cocok untuk lab lokal, edukasi security, atau CTF. Jangan deploy ke server publik.

- ethicalhack3r/DVWA — Damn Vulnerable Web Application (DVWA)

## Lampiran C — Dikeluarkan dari rekomendasi

Beberapa entri dari daftar lama mengarah ke backdoor/webshell/private API/alat berisiko. Untuk menjaga README tetap aman, item tersebut tidak diberi link instalasi dan tidak direkomendasikan.

- mgp25/Instagram-API — tidak direkomendasikan untuk project aplikasi.
- owner888/phpspider — tidak direkomendasikan untuk project aplikasi.
- bartblaze/PHP-backdoors — tidak direkomendasikan untuk project aplikasi.
- JohnTroony/php-webshells — tidak direkomendasikan untuk project aplikasi.
- nbs-system/php-malware-finder — tidak direkomendasikan untuk project aplikasi.
- mgp25/SC-API — tidak direkomendasikan untuk project aplikasi.

## Catatan maintenance

- Update README ini minimal setiap 3 bulan.
- Cek major release PHP, Laravel, Symfony, WordPress, Drupal, Joomla, PHPUnit, Pest, PHPStan, Rector, dan Composer.
- Jika ada package baru yang ingin ditambahkan, gunakan format tabel: `Nama | Package | Versi line | Install | Kegunaan | Status`.
- Jika package sudah abandoned, pindahkan ke bagian migrasi/legacy.